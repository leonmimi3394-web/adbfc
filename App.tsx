...
const App: React.FC = () => {
  ...
  const navItems = [
    ...
    { id: AppView.AI_ASSISTANT, label: 'AI Assistant', icon: Bot },
    { id: AppView.IMAGE_ANALYZER, label: 'Analyze Images', icon: ImageIcon },
  ];
          ...
          <div className="max-w-6xl mx-auto">
            {dataLoading ? (
              ...
              <>
                ...
                {currentView === AppView.IMAGE_ANALYZER && <ImageAnalyzer />}
              </>
            )}
          </div>
        </div>
